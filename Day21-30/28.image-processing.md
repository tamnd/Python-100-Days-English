...
2. Pixel. For an image represented by a sequence of digital values, the smallest unit is a tiny square of a single color at a fixed position. The color and position of all of these tiny squares determine how the image finally appears, and we usually call them pixels. Every image contains a certain number of pixels, and those pixels determine how large the image appears on a screen. Anyone who likes photography or selfies will not find the word pixel unfamiliar.
...
Besides Pillow, Python can also use the more powerful OpenCV library for image and computer-vision work. In our daily work, many tedious and boring tasks can be handled by Python programs. The purpose of programming is to let the computer help us solve problems and reduce repetitive work. After this lesson, you should already have felt some of the fun of drawing and editing images with Python. Of course, Python can do far more than that, so keep learning.
