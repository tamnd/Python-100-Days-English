...
#### Day22 - [Object Serialization and Deserialization](./Day21-30/22.serialization-and-deserialization.md)
...
#### Day23 - [Reading and Writing CSV Files with Python](./Day21-30/23.working-with-csv-files.md)

1. Introduction to CSV files
2. Writing data to CSV files
3. Reading data from CSV files

#### Day24 - [Reading and Writing Excel Files with Python - 1](./Day21-30/24.working-with-excel-files-1.md)
...
#### Day25 - [Reading and Writing Excel Files with Python - 2](./Day21-30/25.working-with-excel-files-2.md)
...
#### Day26 - [Working with Word and PowerPoint Files in Python](./Day21-30/26.working-with-word-and-powerpoint.md)

1. Working with Word documents
2. Generating PowerPoint presentations

#### Day27 - [Working with PDF Files in Python](./Day21-30/27.working-with-pdf-files.md)
...
#### Day28 - [Image Processing with Python](./Day21-30/28.image-processing.md)

1. Introductory concepts
2. Processing images with Pillow
3. Drawing with Pillow

#### Day29 - [Sending Email and SMS with Python](./Day21-30/29.sending-email-and-sms.md)

1. Sending email
2. Sending text messages

#### Day30 - [Applications of Regular Expressions](./Day21-30/30.regular-expressions-in-practice.md)
...
#### [Advanced Python](./Day31-35/31.python-advanced.md)
...
#### [Introduction to Web Frontend](./Day31-35/32-33.web-frontend-introduction.md)
...
#### Day36 - [Overview of Relational Databases and MySQL](./Day36-45/36.relational-databases-and-mysql-overview.md)
